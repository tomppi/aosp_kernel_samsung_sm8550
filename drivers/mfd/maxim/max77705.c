...
#if IS_ENABLED(CONFIG_SEC_PLATFORM_Q5Q) || IS_ENABLED(CONFIG_SEC_PLATFORM_B5Q)
#include <linux/mfd/firmware/max77705C_pass2_specific_foldable.h>
#else
#include <linux/mfd/firmware/max77705C_pass2_specific.h>
#endif
#if defined(CONFIG_MAX77705_USE_EXTRA_FW)
#if IS_ENABLED(CONFIG_SEC_PLATFORM_Q5Q) || IS_ENABLED(CONFIG_SEC_PLATFORM_B5Q)
#include <linux/mfd/firmware/max77705C_pass2_extra1_foldable.h>
#else
